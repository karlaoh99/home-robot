...
/* package HomeRobot-0.1.0.0 */
#ifndef VERSION_HomeRobot
#define VERSION_HomeRobot "0.1.0.0"
#endif /* VERSION_HomeRobot */
#ifndef MIN_VERSION_HomeRobot
#define MIN_VERSION_HomeRobot(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HomeRobot */
...
#define CURRENT_COMPONENT_ID "HomeRobot-0.1.0.0-inplace-HomeRobot"
